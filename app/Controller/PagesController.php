	...
	public function home()
	{
		...
		if (isset($_SESSION['User'])) {
			...
			$reservations = $this->Reservation->find('all', array(
				'fields' =>
				array(
					'Reservation.id', 'Reservation.reservation_bill', 'Reservation.payment_type', 'Reservation.reservation_status', 'Reservation.reservation_date', 'Reservation.reservation_time',
