...
if( $user['User']['type'] == '1' || $user['User']['type'] == '4' ){
   ...
   ?>
    ...
    <li class="nav-item" style="<?php echo $module9;?>"><a class="nav-link fa fa-line-chart" aria-hidden="true" id="calendar" href="product_sales" type="button" > Reporte General</a></li>
